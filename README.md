...
[![PHP Version](https://badgen.net/packagist/php/ghostwriter/workbench?color=777BB4)](https://www.php.net/supported-versions)
[![Packagist Downloads](https://badgen.net/packagist/dt/ghostwriter/workbench?color=F28D1A)](https://packagist.org/packages/ghostwriter/workbench)
...
[![Sponsors via GitHub](https://img.shields.io/github/sponsors/ghostwriter?label=Sponsor+@ghostwriter/workbench&logo=GitHub+Sponsors)](https://github.com/sponsors/ghostwriter)
...
``` bash
composer require ghostwriter/workbench
```
...
- [All Contributors](https://github.com/ghostwriter/workbench/contributors)
